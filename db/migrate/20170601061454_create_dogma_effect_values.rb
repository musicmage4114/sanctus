class CreateDogmaEffectValues < ActiveRecord::Migration[5.1]
  def change
    ...
    add_foreign_key :dogma_effect_values, :dogma_attributes, column: :modified_attribute_id,
                                                             primary_key: :attribute_id
    add_foreign_key :dogma_effect_values, :dogma_attributes, column: :modifying_attribute_id,
                                                             primary_key: :attribute_id
  end
end
