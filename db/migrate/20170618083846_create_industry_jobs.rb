class CreateIndustryJobs < ActiveRecord::Migration[5.1]
  def change
    create_table :industry_jobs, id: false do |t|
      ...
      t.belongs_to :product_type,           polymorphic: true, index: true
    ...
    add_foreign_key :industry_jobs, :characters,          column: :completed_character_id,
                                                          primary_key: :character_id
    add_foreign_key :industry_jobs, :items,               column: :blueprint_type_id,
                                                          primary_key: :type_id
    add_foreign_key :industry_jobs, :items,               column: :product_type_id,
                                                          primary_key: :type_id
    add_foreign_key :industry_jobs, :industry_activities, column: :activity_type,
